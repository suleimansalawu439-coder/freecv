...
export default function Lumen({ data }: { data: ResumeData }) {
  ...
  return (
    <div className="w-[8.5in] min-w-[8.5in] min-h-[11in] bg-white shadow-[0_0_50px_rgba(0,0,0.05)] print:shadow-none p-12 flex flex-col font-sans mx-auto lg:mx-0 shrink-0 text-slate-800 leading-relaxed">
          ...
          <div className="mb-9">
            ...
            <div className="flex flex-wrap gap-2.5">
              {data.skills.map(s => (
                <span
                  key={s.id}
                  className="rounded-full bg-white border border-gray-100 px-4 py-1.5 text-xs font-medium shadow-[0_2px_16px_rgba(0,0,0.06)]"
