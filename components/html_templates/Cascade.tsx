...
export default function Cascade({ data }: { data: ResumeData }) {
  ...
  if (data.summary) {
    sections.push(
      <section key="summary" className={`mb-8 ${indents[0]}`}>
  ...
  if (data.experience.length > 0) {
    sections.push(
      <section key="experience" className={`mb-8 ${indents[1]}`}>
  ...
  if (data.skills.length > 0) {
    sections.push(
      <section key="skills" className={`mb-8 ${indents[2]}`}>
  ...
  if (data.education.length > 0) {
    sections.push(
      <section key="education" className={`mb-8 ${indents[3]}`}>
  ...
  if (data.showProjects && data.projects.length > 0) {
    sections.push(
      <section key="projects" className={`mb-8 ${indents[4]}`}>
  ...
  if (data.showCertifications && data.certifications.length > 0) {
    sections.push(
      <section key="certifications" className={`mb-8 ${indents[5]}`}>
  ...
  if (data.showReferences && data.references.length > 0) {
    sections.push(
      <section key="references" className={`mb-8 ${indents[6]}`}>
  ...
  data.customSections.forEach((section, si) => {
    sections.push(
