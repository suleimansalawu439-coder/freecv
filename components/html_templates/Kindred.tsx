...
export default function Kindred({ data }: { data: ResumeData }) {
  ...
  return (
    <div className="w-[8.5in] min-w-[8.5in] min-h-[11in] bg-white shadow-[0_0_50px_rgba(0,0,0.05)] print:shadow-none p-[0.9in] flex flex-col font-sans mx-auto lg:mx-0 shrink-0 text-slate-800 leading-relaxed">
