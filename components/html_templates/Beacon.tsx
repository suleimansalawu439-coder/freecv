    ...
    <div className="w-[8.5in] min-w-[8.5in] min-h-[11in] bg-white text-gray-900 flex mx-auto font-sans">
      ...
      <aside className="w-[30%] shrink-0 bg-gray-100 px-8 py-10">
        ...
        <div className="bg-white rounded-lg p-5 shadow-sm mb-8">
          ...
          <div className="space-y-2 text-[13px] text-gray-700 break-words">
          ...
          <div className="mb-8">
            ...
            <div className="space-y-2.5">
              {data.skills.map((skill) => (
                <p
                  key={skill.id}
                  className="text-[13px] font-semibold text-gray-800 bg-white px-3 py-2 rounded-md shadow-sm"
                >
                  {skill.name}
                </p>
              ))}
          ...
          <div>
            ...
            <div className="space-y-3">
              {data.references.map((ref) => (
                <div key={ref.id} className="bg-white rounded-lg p-4 shadow-sm">
