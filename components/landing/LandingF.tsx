...
/* Single source of truth — rendered visibly AND emitted as FAQPage JSON-LD in the route. */
export const FAQS: { q: string; a: string }[] = [
  {
    q: "Is Cvyon really free, or is there a paywall waiting at the download?",
    a: "Genuinely free. You can build, grade, and download a PDF or Word file without creating an account or entering a card. There is no paywall at the download, no watermark to crop out, and no trial that quietly becomes a paid plan. Cvyon is funded by recruiters who pay to reach candidates who choose to opt in — never by charging the people who are looking for work.",
  },
  {
    q: "Will a résumé built here get past applicant-tracking systems?",
    a: "Every layout is ATS-friendly by construction: real selectable text (never text rendered as an image), standard section headings, a clean reading order, and none of the clever tricks that blind a parser. On top of that, the grader scores your specific résumé against a specific job post, so you can see and close the gaps before you hit apply.",
  },
  {
    q: "Do I need to create an account to use it?",
    a: "No. The builder runs in your browser and your draft is saved locally on your own device. An account is purely optional — it only exists so you can keep several résumés and pick them up on another device. You can finish and download your work without ever signing in.",
  },
  {
    q: "How does the AI grader work, and what happens to my data?",
    a: "When you grade a résumé, your résumé text and the job description are sent to our AI to compute a match score, then they leave the prompt flow. We do not sell your résumé. Joining the talent pool is a separate, explicit choice you can reverse at any time, and you can export or permanently delete everything we hold about you whenever you like.",
  },
  {
    q: "Can I still edit the résumé after I download it?",
    a: "Yes. The Word export opens as a fully editable document in Microsoft Word or Google Docs, and the PDF is a clean, selectable, print-ready file. Your editable draft also stays in the builder, so you can refine it and re-export as often as you want — at no cost, each time.",
  },
  {
    q: "If it is free, who actually pays for Cvyon?",
    a: "Recruiters and hiring teams who subscribe to search our opt-in talent pool. That revenue funds the free builder. We think the people looking for work should not be the ones paying the toll — so we built the toll booth somewhere else, and we tell you exactly where it stands.",
  },
];
      ...
      <header className="sticky top-0 z-40 border-b-[3px] border-[#141312] bg-[#E8E7E1]/95 backdrop-blur-0">
        <div className="mx-auto flex max-w-[1240px] items-center justify-between px-5 py-4 lg:px-8">
          ...
          <nav className="hidden items-center gap-7 fm text-[11px] font-bold uppercase tracking-[0.18em] md:flex">
            {NAV.map((n) => (<a key={n.href} href={n.href} className="ul">{n.label}</a>))}
          </nav>
