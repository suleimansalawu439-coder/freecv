...
export default function Ridge({ data }: { data: ResumeData }) {
  return (
    <div className="font-mono p-8 sm:p-10 text-zinc-900 bg-white min-h-[1056px] w-full max-w-[816px] mx-auto shadow-sm">
      ...
      <div className="space-y-8">
        {data.summary && (
          <section>
            <h2 className="text-lg font-black uppercase tracking-widest text-zinc-900 border-b-2 border-gray-200 pb-2 mb-4">Profile</h2>
        ...
        {data.experience.length > 0 && (
          <section>
            <h2 className="text-lg font-black uppercase tracking-widest text-zinc-900 border-b-2 border-gray-200 pb-2 mb-4">Experience</h2>
        ...
        <div className="grid grid-cols-2 gap-8">
          {data.education.length > 0 && (
            <section>
              <h2 className="text-lg font-black uppercase tracking-widest text-zinc-900 border-b-2 border-gray-200 pb-2 mb-4">Education</h2>
          ...
          {data.skills.length > 0 && (
            <section>
              <h2 className="text-lg font-black uppercase tracking-widest text-zinc-900 border-b-2 border-gray-200 pb-2 mb-4">Skills</h2>
        ...
        {data.showProjects && data.projects.length > 0 && (
          <section>
            <h2 className="text-lg font-black uppercase tracking-widest text-zinc-900 border-b-2 border-gray-200 pb-2 mb-4">Projects</h2>
        ...
        {data.showCertifications && data.certifications.length > 0 && (
          <section>
            <h2 className="text-lg font-black uppercase tracking-widest text-zinc-900 border-b-2 border-gray-200 pb-2 mb-4">Certifications</h2>
        ...
        {data.showReferences && data.references.length > 0 && (
          <section>
            <h2 className="text-lg font-black uppercase tracking-widest text-zinc-900 border-b-2 border-gray-200 pb-2 mb-4">References</h2>
