...
export default function Bifocal({ data }: { data: ResumeData }) {
  ...
  const summaryShown = hasSummary && isSectionVisible(data, 'personal');
  const skillsShown = hasSkills && isSectionVisible(data, 'skills');
          ...
          {orderSections(data, {
            personal: (
              <>
                ...
                {summaryShown || skillsShown ? (
                  <View style={styles.duoTop}>
                    {orderSections(data, {
                      personal: summaryShown ? (
                        <View style={skillsShown ? styles.duoSummary : styles.duoFull}>
                      ...
                      skills: skillsShown ? (
                        <View style={summaryShown ? styles.duoSkills : styles.duoFull}>
